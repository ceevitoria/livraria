...
public class NotaFiscalMB extends AppMB  {
	...
	private BigDecimal valorTotalNota = new BigDecimal(3.10);
...
//							Produto produto = (Produto)iocControleFacadeUtil.getFacade(IAppFacade.class).findById(context, Produto.class, fornecedorProduto.getProduto().getId());
