...
@NamedQueries({
	...
	@NamedQuery(name="CD.querySel", query="select obj.id as id, obj.codigoBarras as codigoBarras, obj.titulo as titulo, obj.artista as artista, obj.gravadora as gravadora, obj.palavrasChave as palavrasChave, obj.precoUltCompra as precoUltCompra from CD obj order by obj.titulo asc"),
