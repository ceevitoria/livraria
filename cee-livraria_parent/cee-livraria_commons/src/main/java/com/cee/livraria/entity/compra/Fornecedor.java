...
@NamedQueries({
	...
	@NamedQuery(name="Fornecedor.querySel", query="select obj.id as id, obj.nome as nome, obj.razaoSocial as razaoSocial, obj.inscricaoEstatudal as inscricaoEstatudal, obj.cnpj as cnpj, obj.descontoPadrao as descontoPadrao, obj3.id as parcelamentoPadrao_id, obj3.nome as parcelamentoPadrao_nome, obj3.numeroParcelas as parcelamentoPadrao_numeroParcelas, obj3.carenciaInicial as parcelamentoPadrao_carenciaInicial, obj1.id as endereco_cidade_id, obj1.nome as endereco_cidade_nome, obj2.id as endereco_uf_id, obj2.nome as endereco_uf_nome from Fornecedor obj left outer join obj.endereco.cidade as obj1 left outer join obj.endereco.uf as obj2 left outer join obj.parcelamentoPadrao as obj3 order by obj.nome asc"), 
