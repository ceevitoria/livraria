...
@NamedQueries({
	...
	@NamedQuery(name="ConferenciaEntity.querySel", query="select id as id, nome as nome, data as data, statusConferencia as statusConferencia, resultado as resultado from ConferenciaEntity order by nome asc"), 
